...
#python measure-converge.py --model-name m.1.model --ckpt-start 40000 --ckpt-end 44000 --ckpt-step 1000 --model-dir /data/hzzheng/Code.baseline-atta.cifar10_challenge.10.21/data-model/ --gpuid 3
...
#python measure-converge.py --model-name m.3.model --ckpt-step 1000 --ckpt-start 40000 --ckpt-end 45000 --gpuid 0 --model-dir /data/hzzheng/Code.baseline-atta.cifar10_challenge.10.21/data-model/
...
#python measure-converge.py --model-name m.10.model --ckpt-step 1000 --ckpt-start 40000 --ckpt-end 45000  --gpuid 0 --model-dir /data/hzzheng/Code.baseline-atta.cifar10_challenge.10.21/data-model/
...
python measure-converge.py --model-name m.1.model.lr --ckpt-end 39000 --ckpt-step 2000 --gpuid 0
python measure-converge.py --model-name m.2.model.lr --ckpt-end 39000 --ckpt-step 2000 --gpuid 0
python measure-converge.py --model-name m.3.model.lr --ckpt-end 39000 --ckpt-step 2000 --gpuid 0
python measure-converge.py --model-name m.10.model.lr --ckpt-end 39000 --ckpt-step 2000 --gpuid 0
